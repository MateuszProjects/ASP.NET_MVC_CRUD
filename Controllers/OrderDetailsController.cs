...
namespace ASP.NETApplication.Controllers
{
    public class OrderDetailsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "OrderDetailId,Quantity,UnitPrice,OrderId")] OrderDetail orderDetail)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "OrderDetailId,Quantity,UnitPrice,OrderId")] OrderDetail orderDetail)
        {
            if (ModelState.IsValid)
            {
